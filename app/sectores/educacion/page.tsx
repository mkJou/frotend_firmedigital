...
import { FaCalendar,FaGraduationCap, FaUserGraduate, FaChalkboardTeacher, FaCalendarAlt, FaClipboardCheck, FaUsers, FaShieldAlt, FaClock, FaAward, FaTrophy, FaLock, FaCloudUploadAlt, FaMobile, FaEnvelope, FaBuilding, FaPaperPlane } from 'react-icons/fa';
...
export default function Educacion() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ email, companyName, section: 'Educación' }),
      });
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-gray-100">
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Sector Educación Background"
            fill
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 lg:px-8 text-center">
          <div className="space-y-8">
                      ...
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 rounded-full border border-blue-400/30">
                        ...
                        <span className="text-sm font-medium text-blue-300">Sector Educación</span>
                      </div>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                          <span className="block text-white mb-2 relative inline-block">
                            <span 
                              ...
                              data-text=""
                            >
                              ¡Transforma la educación con la firma digital FIRMEDIGITAL!
                            </span>
                          </span>
                          <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl">
                            Agiliza trámites académicos y administrativos
                          </span>
                </h1>
                      </div>
                      ...
                      <div className="space-y-6">
                        <p className="text-lg text-gray-300 leading-relaxed">
                          Optimiza los procesos de tu institución con nuestra solución de firma digital segura y certificada.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-900/80 to-black/80 p-6 rounded-xl border border-blue-500/30 shadow-lg shadow-blue-500/10 mb-8 backdrop-blur-sm">
                  ...
                  <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                    ...
                    <div>
                      <label htmlFor="companyName" className="block text-sm font-medium text-gray-300 mb-1">Nombre de la Institución</label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-[#0A0A0A]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <p className="text-gray-300 text-lg text-center leading-relaxed mb-8">
              El sector educativo se integra perfectamente con la plataforma de FIRMEDIGITAL, aprovechando sus funcionalidades de firma electrónica, gestión documental y flujo de trabajo. Se implementan módulos específicos para documentación académica, certificados y procesos administrativos, creando una solución integral que se adapta a las necesidades de cada institución educativa.
            </p>
            <div className="flex justify-center">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4">
              ...
              <span className="block bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">Sector Educativo</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            <div className="lg:col-span-5 order-2 lg:order-1 relative mx-auto w-full flex items-center">
              <div className="w-full h-[600px] md:h-[650px] lg:h-[700px] relative">
                <img 
                  src="/images/beneeduca.jpg" 
                  alt="Beneficios Educación" 
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                {[
                  { icon: <FaGraduationCap className="text-3xl" />, title: "Gestión Académica", description: "Firma digital de documentos académicos con validez legal.", gradient: "from-blue-500 to-blue-600", textColor: "text-blue-300" },
                  { icon: <FaChalkboardTeacher className="text-3xl" />, title: "Docencia Digital", description: "Flujos optimizados para profesores y coordinaciones.", gradient: "from-purple-500 to-purple-600", textColor: "text-purple-300" },
                  { icon: <FaUserGraduate className="text-3xl" />, title: "Servicios Estudiantiles", description: "Certificados, títulos y constancias con firma electrónica.", gradient: "from-green-500 to-green-600", textColor: "text-green-300" },
                  { icon: <FaCalendarAlt className="text-3xl" />, title: "Procesos Administrativos", description: "Trámites internos con validación digital y trazabilidad.", gradient: "from-pink-500 to-pink-600", textColor: "text-pink-300" },
                  { icon: <FaClipboardCheck className="text-3xl" />, title: "Evaluación y Acreditación", description: "Gestión segura de documentos de evaluación.", gradient: "from-indigo-500 to-indigo-600", textColor: "text-indigo-300" },
                  { icon: <FaUsers className="text-3xl" />, title: "Comunidad Educativa", description: "Acceso seguro a documentos desde cualquier lugar.", gradient: "from-orange-500 to-orange-600", textColor: "text-orange-300" }
                ].map((benefit, index) => (
      ...
      {/* ¿Por qué elegir FIRMEDIGITAL para instituciones educativas? Section */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Documentos académicos con validez legal garantizada
            </p>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                <p className="text-xl md:text-2xl text-white leading-relaxed">
                  En FirmeDigital, garantizamos que sus certificados académicos, títulos universitarios y documentos educativos cumplen con las leyes venezolanas y se gestionan 100% dentro del territorio nacional, respaldados por SUSCERTE.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Nuestra plataforma ofrece una solución integral para instituciones educativas que asegura la validez legal de sus documentos electrónicos, cumpliendo con los requisitos del Ministerio de Educación y otros entes.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Certificados académicos con validez legal</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Títulos digitales verificables</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Autenticación de identidad para estudiantes</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Expedientes académicos digitales seguros</span></div>
                </div>
