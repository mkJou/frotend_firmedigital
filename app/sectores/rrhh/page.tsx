...
import { FaUserTie, FaUsers, FaChartLine, FaCogs, FaClipboard, FaLock, FaMobile, FaCog, FaPlug, FaWpforms, FaLightbulb, FaCloud, FaCalendar, FaEnvelope, FaBuilding, FaPaperPlane } from 'react-icons/fa';
      ...
      <section ref={heroRef} className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden pt-[7rem]">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Recursos Humanos Background"
            fill
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 rounded-full border border-blue-400/30">
              ...
              <span className="text-sm font-medium text-blue-300">Recursos Humanos Digital</span>
            </div>
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl">
                  Digitaliza contratos, nóminas y expedientes con validez legal
                </span>
                </h1>
            </div>
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                Optimiza la gestión documental de RRHH con firma digital certificada, flujos automatizados y trazabilidad completa.
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-[#0A0A0A]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <p className="text-gray-300 text-lg text-center leading-relaxed mb-8">
              El sector de Recursos Humanos se integra perfectamente con la plataforma de FIRMEDIGITAL, aprovechando sus funcionalidades de firma electrónica, gestión documental y flujo de trabajo. Se implementan módulos específicos para contratos laborales, nóminas y documentación de personal, creando una solución integral que se adapta a las necesidades de cada departamento de RRHH.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              ...
              <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">Recursos Humanos</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                description: "Gestión digital completa de registros y flujos de RR.HH., optimizando procesos."
                  },
                  {
                icon: <FaLock className="text-3xl text-blue-300" />,
                    title: "Documentos Seguros",
                description: "Permisos y protección avanzada para información sensible."
                  },
                  {
                icon: <FaMobile className="text-3xl text-blue-300" />,
                    title: "Acceso Flexible",
                description: "Gestión web y móvil con acceso seguro desde cualquier lugar."
                  },
                  {
                icon: <FaCogs className="text-3xl text-blue-300" />,
                    title: "Procesos Inteligentes",
                description: "Automatización y optimización de tareas repetitivas."
                  },
                  {
                icon: <FaPlug className="text-3xl text-blue-300" />,
                    title: "Integración Simple",
                description: "Compatible con software existente de RR.HH."
                  },
                  {
                icon: <FaWpforms className="text-3xl text-blue-300" />,
                    title: "Formularios Digitales",
                description: "Formularios inteligentes con validación automática."
                  }
                ].map((benefit, index) => (
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Documentos laborales con validez legal garantizada
            </p>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                <p className="text-xl md:text-2xl text-white leading-relaxed">
                  En FirmeDigital, garantizamos que sus contratos laborales, nóminas y documentos de Recursos Humanos cumplen con las leyes venezolanas y se gestionan 100% dentro del territorio nacional, respaldados por SUSCERTE.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Nuestra plataforma ofrece una solución integral para profesionales de RRHH que asegura la validez legal de sus documentos electrónicos, cumpliendo con todos los requisitos establecidos por el Ministerio del Trabajo y demás entes reguladores. Al elegir FIRMEDIGITAL para su departamento de Recursos Humanos, usted obtiene:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Firmas digitales en contratos laborales</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Validez legal en nóminas y liquidaciones</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Verificación de identidad para empleados</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Almacenamiento seguro de expedientes laborales</span></div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos de Recursos Humanos con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la integridad y confidencialidad de la información personal de sus empleados, reduciendo el riesgo de conflictos laborales y permitiendo una gestión más eficiente de los trámites de personal en la República Bolivariana de Venezuela.
                </p>
