          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-8">
                ...
                ¡Digitaliza tus procesos<br /> industriales con<br /> FIRMEDIGITAL!
                </h1>
                ...
                <div className="bg-gradient-to-r from-gray-800/50 to-blue-900/10 border-l-4 border-blue-500 rounded-lg shadow-lg hover:shadow-blue-500/20 hover:border-blue-400 transition-all duration-300 backdrop-blur-sm p-6 mb-8">
                  ...
                  Optimiza la gestión documental en tu industria con nuestra solución de firma digital. Mejora la eficiencia y reduce costos.
                  </p>
                </div>
            ...
            <div className="relative h-[300px] lg:h-[500px] rounded-xl overflow-hidden shadow-2xl shadow-blue-500/20 border border-blue-500/30 transform hover:scale-[1.02] transition-all duration-500">
              <Image
                src="/images/insdustriass.jpg"
                alt="Sector industria"
                fill
                ...
                {[
                  {
                    ...
                    description: "Optimiza procesos industriales con firmas digitales que agilizan aprobaciones y verificaciones."
                  },
                  {
                    icon: <FaChartBar className="text-4xl text-blue-400" />,
                    title: "Trazabilidad Total",
                    description: "Seguimiento completo del ciclo de vida de documentos críticos para auditorías y control."
                  },
                  {
                    icon: <FaShieldAlt className="text-4xl text-blue-400" />,
                    title: "Seguridad Avanzada",
                    description: "Protección de información sensible con certificados digitales y cifrado de última generación."
                  },
                  {
                    icon: <FaHandshake className="text-4xl text-blue-400" />,
                    title: "Mejora en Relaciones",
                    description: "Facilita acuerdos con proveedores y clientes mediante procesos de firma ágiles y seguros."
                  },
                  {
                    icon: <FaLeaf className="text-4xl text-blue-400" />,
                    title: "Sostenibilidad",
                    description: "Reducción significativa del uso de papel, contribuyendo a iniciativas ecológicas empresariales."
                  },
                  {
                    icon: <FaGlobe className="text-4xl text-blue-400" />,
                    title: "Acceso Global",
                    description: "Gestión de documentos desde cualquier ubicación, ideal para empresas con múltiples sedes."
                  }
                ].map((benefit, index) => (
                  <div
                    key={index}
