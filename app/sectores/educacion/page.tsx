          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-8">
                ...
                ¡Transforma la educación<br /> con la firma digital<br /> FIRMEDIGITAL!
                </h1>
                ...
                <div className="bg-gradient-to-r from-gray-800/50 to-blue-900/10 border-l-4 border-blue-500 rounded-lg shadow-lg hover:shadow-blue-500/20 hover:border-blue-400 transition-all duration-300 backdrop-blur-sm p-6 mb-8">
                  ...
                  Optimiza los procesos administrativos en tu institución educativa con nuestra solución de firma digital. Simplifica trámites y mejora la eficiencia.
                  </p>
                </div>
                ...
                {[
                  {
                    ...
                    description: "Firma digital de documentos académicos con validez legal y respaldo digital."
                  },
                  {
                    icon: <FaChalkboardTeacher className="text-4xl text-blue-400" />,
                    title: "Docencia Digital",
                    description: "Documentación académica segura para profesores, con flujos de trabajo optimizados."
                  },
                  {
                    icon: <FaUserGraduate className="text-4xl text-blue-400" />,
                    title: "Servicios Estudiantiles",
                    description: "Gestión digital de certificados, títulos y constancias con firma electrónica certificada."
                  },
                  {
                    icon: <FaCalendarAlt className="text-4xl text-blue-400" />,
                    title: "Procesos Administrativos",
                    description: "Optimización de trámites internos con validación digital y trazabilidad completa."
                  },
                  {
                    icon: <FaClipboardCheck className="text-4xl text-blue-400" />,
                    title: "Evaluación y Acreditación",
                    description: "Gestión segura de documentos para procesos de evaluación y acreditación institucional."
                  },
                  {
                    icon: <FaUsers className="text-4xl text-blue-400" />,
                    title: "Comunidad Educativa",
                    description: "Acceso seguro a documentos oficiales para toda la comunidad educativa desde cualquier lugar."
                  }
                ].map((benefit, index) => (
                  <div
                    key={index}
        ...
        <div className="relative mx-auto max-w-7xl px-4 z-10">
          <div className="flex flex-col items-center justify-center text-center mb-10">
            <div className="inline-block mb-6 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full">
              <span className="text-white font-semibold">¿Por qué elegir FIRMEDIGITAL para instituciones educativas?</span>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  Nuestra plataforma ofrece una solución integral para instituciones educativas que asegura la validez legal de sus documentos electrónicos, cumpliendo con todos los requisitos establecidos por el Ministerio de Educación y demás entes reguladores. Al elegir FIRMEDIGITAL para su institución educativa, usted obtiene:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">Certificados académicos con validez legal</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Títulos digitales verificables</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Autenticación de identidad para estudiantes</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Expedientes académicos digitales seguros</span>
                  </div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos académicos con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la integridad y autenticidad de los documentos educativos, reduciendo el riesgo de falsificaciones y permitiendo una gestión más eficiente de los trámites académicos en Venezuela, protegiendo el valor de las credenciales emitidas por su institución.
                </p>
