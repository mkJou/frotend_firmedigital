          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-8">
                ...
                ¡Revoluciona tus<br /> servicios financieros<br /> con FIRMEDIGITAL!
                </h1>
                ...
                <div className="bg-gradient-to-r from-gray-800/50 to-blue-900/10 border-l-4 border-blue-500 rounded-lg shadow-lg hover:shadow-blue-500/20 hover:border-blue-400 transition-all duration-300 backdrop-blur-sm p-6 mb-8">
                  ...
                  Agiliza tus procesos financieros con nuestra solución de firma digital. Seguridad y cumplimiento normativo garantizados.
                  </p>
                </div>
      ...
      <section ref={benefitsRef} className="py-20 bg-gradient-to-b from-black to-gray-900 relative">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl lg:text-5xl font-bold mb-16 text-center bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-clip-text text-transparent">
            Beneficios para el Sector Tecnología Financiera
          </h2>
                ...
                {[
                  {
                    ...
                    description: "Optimiza recursos eliminando papel y automatizando procesos de firma y verificación."
                  },
                  {
                    icon: <FaShieldAlt className="text-4xl text-blue-400" />,
                    title: "Mayor Seguridad",
                    description: "Protección avanzada contra fraudes y accesos no autorizados con certificación digital."
                  },
                  {
                    icon: <FaBolt className="text-4xl text-blue-400" />,
                    title: "Eficiencia Operativa",
                    description: "Procesos ágiles y reducción de errores en operaciones financieras y transaccionales."
                  },
                  {
                    icon: <FaUserCheck className="text-4xl text-blue-400" />,
                    title: "Mejor Experiencia",
                    description: "Transacciones rápidas y seguras para los usuarios con validación en tiempo real."
                  },
                  {
                    icon: <FaUniversity className="text-4xl text-blue-400" />,
                    title: "Cumplimiento Regulatorio",
                    description: "Facilita el cumplimiento de normativas financieras con registros verificables y auditables."
                  },
                  {
                    icon: <FaSyncAlt className="text-4xl text-blue-400" />,
                    title: "Escalabilidad",
                    description: "Adaptación a volúmenes crecientes de transacciones sin comprometer la seguridad."
                  }
                ].map((benefit, index) => (
                  <div
                    key={index}
        ...
        <div className="relative mx-auto max-w-7xl px-4 z-10">
          <div className="flex flex-col items-center justify-center text-center mb-10">
            <div className="inline-block mb-6 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full">
              <span className="text-white font-semibold">¿Por qué elegir FIRMEDIGITAL para empresas fintech?</span>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  Nuestra plataforma ofrece una solución integral para empresas fintech que asegura la validez legal de sus operaciones electrónicas, cumpliendo con todos los requisitos establecidos por SUDEBAN, SUNAVAL y demás entes reguladores. Al elegir FIRMEDIGITAL para su plataforma fintech, usted obtiene:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">Contratos digitales legalmente vinculantes</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Verificación KYC con validez regulatoria</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Autenticación de identidad para transacciones</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Cumplimiento de normativas AML/CFT</span>
                  </div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos financieros con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la seguridad y trazabilidad de las transacciones digitales, reduciendo el riesgo de fraudes y permitiendo una experiencia de usuario fluida mientras se mantiene la conformidad con las regulaciones financieras venezolanas, todo procesado en servidores locales bajo jurisdicción nacional.
                </p>
