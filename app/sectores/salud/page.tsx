...
export default function SectorSalud() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 lg:px-8 text-center">
          <div className="space-y-8">
                      ...
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/20 rounded-full border border-green-400/30">
                        ...
                        <span className="text-sm font-medium text-green-300">Sector Salud</span>
                      </div>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                          <span className="block text-white mb-2 relative inline-block">
                            <span 
                              ...
                              data-text=""
                            >
                              ¡Proteja historias médicas electrónicas con firma digital!
                            </span>
                          </span>
                          <span className="block bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl">
                            Optimiza la gestión de documentos clínicos y recetas médicas
                          </span>
                        </h1>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4">
              ...
              <span className="block bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">Sector Salud</span>
            </h2>
      ...
      {/* ¿Por qué elegir FIRMEDIGITAL para el sector salud? Section */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Documentos médicos con validez legal garantizada
            </p>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                <p className="text-xl md:text-2xl text-white leading-relaxed">
                  En FirmeDigital, garantizamos que sus historias clínicas, recetas médicas y consentimientos informados cumplen con las leyes venezolanas y se gestionan 100% dentro del territorio nacional, respaldados por SUSCERTE.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Nuestra plataforma ofrece una solución integral para profesionales de la salud que asegura la validez legal de sus documentos electrónicos, cumpliendo con todos los requisitos establecidos por el Ministerio de Salud y demás entes reguladores. Al elegir FIRMEDIGITAL para su práctica médica, usted obtiene:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">Firmas digitales en historias clínicas</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Validez legal en recetas médicas</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Consentimientos informados verificables</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Almacenamiento seguro de datos clínicos</span>
                  </div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos médicos con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la integridad y confidencialidad de la información clínica de sus pacientes, reduciendo el riesgo de falsificaciones y permitiendo una gestión más eficiente de la documentación médica en la República Bolivariana de Venezuela.
                </p>
