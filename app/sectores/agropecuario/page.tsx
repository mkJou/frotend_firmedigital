...
import { FaLeaf, FaChartLine, FaClipboardCheck, FaHandshake, FaFileSignature, FaMobileAlt, FaCalendar, FaEnvelope, FaBuilding, FaPaperPlane } from 'react-icons/fa';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ email, companyName, section: 'Agropecuario' }),
      });
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 rounded-full border border-blue-400/30">
              ...
              <span className="text-sm font-medium text-blue-300">Sector Agropecuario</span>
            </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="block text-white mb-2 relative inline-block">
                  <span 
                    ...
                    data-text="Transformación Digital del Campo"
                  >
                ...
                <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl">
                  Firma digital y gestión documental con validez legal
                </span>
              </h1>
            </div>
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                Optimiza trámites agrícolas, contratos y certificaciones con procesos seguros y 100% legales.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              ...
              <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">Sector Agropecuario</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: <FaLeaf className="text-3xl text-blue-300" />, title: "Gestión Agronómica", description: "Control digital de siembra a cosecha con validez legal." },
              { icon: <FaChartLine className="text-3xl text-blue-300" />, title: "Control Económico", description: "Costos y gastos con firma digital para auditorías." },
              { icon: <FaClipboardCheck className="text-3xl text-blue-300" />, title: "Cumplimiento Legal", description: "Cuaderno de Campo y certificaciones digitales." },
              { icon: <FaMobileAlt className="text-3xl text-blue-300" />, title: "Accesibilidad Total", description: "Acceso seguro desde campo o oficina." },
              { icon: <FaHandshake className="text-3xl text-blue-300" />, title: "Contratos Seguros", description: "Firma digital con proveedores y clientes." },
              { icon: <FaFileSignature className="text-3xl text-blue-300" />, title: "Trazabilidad Completa", description: "Registro de firmas y certificaciones end-to-end." }
            ].map((benefit, index) => (
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
              ...
              <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">para el sector agropecuario?</span>
            </h2>

            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">Transformación digital del campo venezolano</p>
          ...
          <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-gray-200/20 rounded-3xl p-8 md:p-12 max-w-5xl mx-auto shadow-2xl">
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                <p className="text-xl md:text-2xl text-white leading-relaxed">En FirmeDigital, garantizamos que sus documentos y trámites agrícolas cumplen con las leyes venezolanas y se gestionan 100% dentro del territorio nacional, respaldados por SUSCERTE.</p>
                <p className="text-lg text-gray-300 leading-relaxed">Nuestra plataforma ofrece una solución integral para el sector agropecuario que asegura la validez legal de sus documentos electrónicos, cumpliendo con todos los requisitos establecidos para trámites agrícolas, ganaderos y de comercialización. Al elegir FIRMEDIGITAL para su operación agropecuaria, usted obtiene:</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Gestión digital de guías de movilización</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Certificados sanitarios digitales válidos</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Contratos de compraventa con validez legal</span></div>
                  <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Trámites con instituciones agrícolas oficiales</span></div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">Al digitalizar sus procesos agrícolas con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la agilización de trámites que tradicionalmente requerían desplazamientos y tiempos de espera prolongados.</p>
        ...
        <div className="mx-auto max-w-7xl px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              ...
              <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">Precios</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Soluciones flexibles para todas tus necesidades</p>
          </div>
