          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-8">
                ...
                ¡Revoluciona tu gestión<br /> de Recursos Humanos<br /> con FIRMEDIGITAL!
                </h1>
                ...
                <div className="bg-gradient-to-r from-gray-800/50 to-blue-900/10 border-l-4 border-blue-500 rounded-lg shadow-lg hover:shadow-blue-500/20 hover:border-blue-400 transition-all duration-300 backdrop-blur-sm p-6 mb-8">
                  ...
                  Optimiza la gestión documental en tu departamento de RRHH con nuestra solución de firma digital. Simplifica contratos, nóminas y más.
                  </p>
                </div>
                ...
                {[
                  {
                    ...
                    description: "Gestión digital completa de registros y flujos de RR.HH., optimizando todos los procesos administrativos."
                  },
                  {
                    icon: <FaLock className="text-4xl text-blue-400" />,
                    title: "Documentos Seguros",
                    description: "Protección avanzada y permisos personalizables para información sensible de empleados y organización."
                  },
                  {
                    icon: <FaMobile className="text-4xl text-blue-400" />,
                    title: "Acceso Flexible",
                    description: "Gestión web y móvil para equipos remotos, permitiendo acceso seguro desde cualquier ubicación."
                  },
                  {
                    icon: <FaCogs className="text-4xl text-blue-400" />,
                    title: "Procesos Inteligentes",
                    description: "Análisis y optimización de flujos de trabajo con automatización de tareas repetitivas."
                  },
                  {
                    icon: <FaPlug className="text-4xl text-blue-400" />,
                    title: "Integración Simple",
                    description: "Compatible con software existente de RR.HH., facilitando la transición digital sin interrupciones."
                  },
                  {
                    icon: <FaWpforms className="text-4xl text-blue-400" />,
                    title: "Formularios Digitales",
                    description: "Elimina entrada manual de datos con formularios digitales inteligentes y validación automática."
                  }
                ].map((benefit, index) => (
                  <div
                    key={index}
        ...
        <div className="relative mx-auto max-w-7xl px-4 z-10">
          <div className="flex flex-col items-center justify-center text-center mb-10">
            <div className="inline-block mb-6 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full">
              <span className="text-white font-semibold">¿Por qué elegir FIRMEDIGITAL para Recursos Humanos?</span>
            </div>
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">Firmas digitales en contratos laborales</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Validez legal en nóminas y liquidaciones</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Verificación de identidad para empleados</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Almacenamiento seguro de expedientes laborales</span>
                  </div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">
