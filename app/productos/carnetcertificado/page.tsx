...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 via-transparent to-blue-800/10 pointer-events-none"></div>
                  ...
                  <div className="order-2 lg:order-1">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start">
                        ...
                        <p className="ml-3 text-gray-300">Firma digital para recetas e informes médicos con validez legal</p>
                      </div>
                      <div className="flex items-start">
                        <div className="flex-shrink-0 mt-1">
                          <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="relative border-t border-white/5 pricing-section bg-gradient-to-b from-blue-950 to-black">
