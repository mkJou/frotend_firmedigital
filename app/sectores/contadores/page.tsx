          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-8">
                ...
                ¡Optimiza tus procesos<br /> contables con<br /> FIRMEDIGITAL!
                </h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Generación y firma de informes contables con validez ante entidades fiscales."
                  },
                  {
                    icon: <FaChartPie className="text-4xl text-blue-400" />,
                    title: "Análisis Financiero",
                    description: "Herramientas de análisis y visualización de datos financieros con firma digital."
                  },
                  {
                    icon: <FaFileAlt className="text-4xl text-blue-400" />,
                    title: "Documentación Fiscal",
                    description: "Gestión de documentos fiscales con certificación y trazabilidad completa."
                  },
                  {
                    icon: <FaBook className="text-4xl text-blue-400" />,
                    title: "Automatización",
                    description: "Automatización de firmas y envío de reportes financieros a clientes y autoridades."
                  }
                ].map((benefit, index) => (
                  <div
                    key={index}
        ...
        <div className="relative mx-auto max-w-7xl px-4 z-10">
          <div className="flex flex-col items-center justify-center text-center mb-10">
            <div className="inline-block mb-6 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full">
              <span className="text-white font-semibold">¿Por qué elegir FIRMEDIGITAL para contadores?</span>
            </div>
          ...
          <div className="relative bg-[#0A0A0A]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos contables con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la integridad y confidencialidad de la información financiera de sus clientes, reduciendo el riesgo de fraudes y permitiendo una gestión más eficiente de los trámites fiscales y contables en la República Bolivariana de Venezuela.
                </p>
