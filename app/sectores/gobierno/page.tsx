...
export default function SectorGobierno() {
  ...
  return (
    <main className="min-h-screen bg-[#000000] text-white">
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Sector Gobierno Background"
            fill
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 lg:px-8 text-center">
          <div className="space-y-8">
                      ...
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 rounded-full border border-blue-400/30">
                        ...
                        <span className="text-sm font-medium text-blue-300">Sector Gobierno</span>
                      </div>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                          <span className="block text-white mb-2 relative inline-block">
                            <span 
                              ...
                              data-text=""
                            >
                              Digitalice trámites gubernamentales con firma electrónica válida
                            </span>
                          </span>
                          <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl">
                            Transparencia, eficiencia y soberanía tecnológica
                          </span>
                </h1>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4">
              ...
              <span className="block bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">Sector Gobierno</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6">
                {[
                  { icon: <FaLandmark className="text-3xl" />, title: "Gestión Gubernamental", description: "Firma digital de documentos oficiales con validez legal y respaldo digital.", gradient: "from-blue-500 to-blue-600", textColor: "text-blue-300" },
                  { icon: <FaUserTie className="text-3xl" />, title: "Trámites Ciudadanos", description: "Servicios digitales para la ciudadanía con mayor rapidez y seguridad.", gradient: "from-purple-500 to-purple-600", textColor: "text-purple-300" },
                  { icon: <FaShieldAlt className="text-3xl" />, title: "Seguridad Estatal", description: "Protección avanzada de documentos con cifrado de última generación.", gradient: "from-green-500 to-green-600", textColor: "text-green-300" },
                  { icon: <FaUsers className="text-3xl" />, title: "Participación Ciudadana", description: "Interacción segura entre ciudadanos y entidades gubernamentales.", gradient: "from-pink-500 to-pink-600", textColor: "text-pink-300" },
                  { icon: <FaChartLine className="text-3xl" />, title: "Transparencia", description: "Rendición de cuentas y acceso a información pública verificable.", gradient: "from-indigo-500 to-indigo-600", textColor: "text-indigo-300" },
                  { icon: <FaCogs className="text-3xl" />, title: "Modernización", description: "Impulsa la transformación digital con soluciones innovadoras.", gradient: "from-orange-500 to-orange-600", textColor: "text-orange-300" }
                ].map((benefit, index) => (
      ...
      {/* ¿Por qué elegir FIRMEDIGITAL para instituciones gubernamentales? Section */}
          ...
          <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-gray-200/20 rounded-3xl p-8 md:p-12 max-w-5xl mx-auto shadow-2xl">
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  Nuestra plataforma ofrece una solución integral para instituciones públicas que asegura la validez legal de sus documentos electrónicos, cumpliendo con la Ley de Infogobierno y demás normativas vigentes. Al elegir FIRMEDIGITAL para su entidad, usted obtiene:
                </p>
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos con una plataforma certificada por SUSCERTE, se garantiza soberanía tecnológica, seguridad y trazabilidad en la gestión pública.
                </p>
