...
import { FaCalendar, FaCalendarCheck, FaUserFriends, FaClipboardList, FaGlassCheers, FaBriefcase, FaMusic, FaEnvelope, FaBuilding, FaPaperPlane } from 'react-icons/fa';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ email, companyName, section: 'Eventos' }),
      });
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 rounded-full border border-blue-400/30">
              ...
              <span className="text-sm font-medium text-blue-300">Sector Eventos</span>
            </div>
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl">
                  Firma digital y accesos con validez legal
                </span>
                </h1>
            </div>
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                Simplifica contratos, pases con QR y acuerdos con proveedores y asistentes de forma segura y 100% legal.
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-[#0A0A0A]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <p className="text-gray-300 text-lg text-center leading-relaxed mb-8">
              El sector de eventos se integra perfectamente con la plataforma de FIRMEDIGITAL, aprovechando sus funcionalidades de firma electrónica, gestión documental y flujo de trabajo. Se implementan módulos específicos para contratos con proveedores, acuerdos con clientes y documentación legal, creando una solución integral que se adapta a las necesidades de cada empresa organizadora de eventos.
            </p>
            <div className="flex justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              ...
              <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">Sector de Eventos</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: <FaCalendarCheck className="text-3xl text-blue-300" />, title: "Pases Personalizados", description: "Invitación única con QR como acceso con validez legal." },
              { icon: <FaUserFriends className="text-3xl text-blue-300" />, title: "Registro Eficiente", description: "Asistencias en tiempo real sin errores." },
              { icon: <FaClipboardList className="text-3xl text-blue-300" />, title: "Sostenibilidad", description: "Cero papel: invitaciones y pases digitales." },
              { icon: <FaGlassCheers className="text-3xl text-blue-300" />, title: "Mejor Experiencia", description: "Proceso fluido desde invitación hasta acceso." },
              { icon: <FaBriefcase className="text-3xl text-blue-300" />, title: "Gestión Simplificada", description: "Todo centralizado con firmas digitales." },
              { icon: <FaMusic className="text-3xl text-blue-300" />, title: "Análisis de Datos", description: "Estadísticas para optimizar siguientes eventos." }
                ].map((benefit, index) => (
  ...
  <div className="relative mx-auto max-w-7xl px-6 lg:px-8 z-10">
    <div className="text-center mb-20">
      ...
      <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
        ...
        <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">para organizadores de eventos?</span>
      </h2>
      <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">Documentos de eventos con validez legal garantizada</p>
    ...
    <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-gray-200/20 rounded-3xl p-8 md:p-12 max-w-5xl mx-auto shadow-2xl">
          ...
          <svg className="w-10 h-10 text-blue-400" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </div>
              <div className="space-y-6 text-left">
          <p className="text-xl md:text-2xl text-white leading-relaxed">En FirmeDigital, garantizamos que sus contratos con proveedores, acuerdos con participantes y documentos de eventos cumplen con las leyes venezolanas y se gestionan 100% dentro del territorio nacional, respaldados por SUSCERTE.</p>
          <p className="text-lg text-gray-300 leading-relaxed">Nuestra plataforma ofrece una solución integral para organizadores de eventos que asegura la validez legal de sus documentos electrónicos. Al elegir FIRMEDIGITAL para su empresa de eventos, usted obtiene:</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Contratos con proveedores legalmente válidos</span></div>
            <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Autorizaciones y permisos digitales</span></div>
            <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Certificados de asistencia verificables</span></div>
            <div className="flex items-start gap-3"><div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center mt-1"><svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div><span className="text-gray-300">Acuerdos de confidencialidad seguros</span></div>
                    </div>
          <p className="text-lg text-gray-300 leading-relaxed">Digitalice la logística y documentación de sus eventos con una plataforma certificada por SUSCERTE para mayor seguridad y eficiencia.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <p className="text-xl text-gray-400">No se encontraron artículos en la categoría Eventos.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
