          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-8">
                ...
                ¡Digitaliza tu sector<br /> agropecuario con<br /> FIRMEDIGITAL!
                </h1>
                ...
                <div className="bg-gradient-to-r from-gray-800/50 to-blue-900/10 border-l-4 border-blue-500 rounded-lg shadow-lg hover:shadow-blue-500/20 hover:border-blue-400 transition-all duration-300 backdrop-blur-sm p-6 mb-8">
                  ...
                  Optimiza la gestión documental en el campo con nuestra solución de firma digital. Simplifica trámites y mejora la eficiencia.
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            <div className="lg:col-span-5 order-2 lg:order-1 relative mx-auto w-full flex items-center">
              <div className="w-full h-[600px] md:h-[650px] lg:h-[700px] relative">
                <img 
                  src="/images/beneagro.webp" 
                  alt="Beneficios Agropecuario" 
                ...
                {[
                  {
                    ...
                    description: "Control completo y digitalizado de actividades desde siembra hasta cosecha con validez legal."
                  },
                  {
                    icon: <FaChartLine className="text-4xl text-blue-400" />,
                    title: "Control Económico",
                    description: "Registro eficiente de costos y gastos operativos con firma digital para auditorías y controles."
                  },
                  {
                    icon: <FaClipboardCheck className="text-4xl text-blue-400" />,
                    title: "Cumplimiento Legal",
                    description: "Gestión del Cuaderno de Campo y certificaciones con validez legal y respaldo digital."
                  },
                  {
                    icon: <FaMobileAlt className="text-4xl text-blue-400" />,
                    title: "Accesibilidad Total",
                    description: "Acceso seguro desde cualquier dispositivo y ubicación, ideal para trabajo en campo."
                  },
                  {
                    icon: <FaHandshake className="text-4xl text-blue-400" />,
                    title: "Contratos Seguros",
                    description: "Firma digital de contratos con proveedores, distribuidores y clientes con validez legal."
                  },
                  {
                    icon: <FaFileSignature className="text-4xl text-blue-400" />,
                    title: "Trazabilidad Completa",
                    description: "Seguimiento detallado de toda la documentación con registro de firmas y certificaciones."
                  }
                ].map((benefit, index) => (
                  <div
                    key={index}
        ...
        <div className="relative mx-auto max-w-7xl px-4 z-10">
          <div className="flex flex-col items-center justify-center text-center mb-10">
            <div className="inline-block mb-6 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full">
              <span className="text-white font-semibold">¿Por qué elegir FIRMEDIGITAL para el sector agropecuario?</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 leading-tight max-w-4xl">
              Transformación digital del campo venezolano
            </h2>
          </div>
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">Gestión digital de guías de movilización</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Certificados sanitarios digitales válidos</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Contratos de compraventa con validez legal</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Trámites con instituciones agrícolas oficiales</span>
                  </div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos agrícolas con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la agilización de trámites que tradicionalmente requerían desplazamientos y tiempos de espera prolongados, permitiéndole enfocarse en lo que realmente importa: la productividad de su actividad agropecuaria.
                </p>
