...
import { FaBuilding, FaUsersCog, FaMagic, FaSync, FaFileInvoiceDollar, FaChartLine, FaCalculator, FaChartPie, FaChartBar, FaBullseye, FaFileAlt, FaBook, FaBrain, FaCalendar, FaEnvelope, FaPaperPlane } from 'react-icons/fa';
...
export default function Contadores() {
  ...
  // Referencias para la sección de precios
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ email, companyName, section: 'Contadores' }),
      });
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-gray-100">
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Sector Contadores Background"
            fill
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 lg:px-8 text-center">
          <div className="space-y-8">
                      ...
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 rounded-full border border-blue-400/30">
                        ...
                        <span className="text-sm font-medium text-blue-300">Sector Contadores</span>
                      </div>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                          <span className="block text-white mb-2 relative inline-block">
                            <span 
                              ...
                              data-text=""
                            >
                              ¡Optimiza tus procesos contables con FIRMEDIGITAL!
                            </span>
                          </span>
                          <span className="block bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl">
                            Firma digital para facturas, estados y contratos
                          </span>
                        </h1>
                      </div>
                      ...
                      <div className="space-y-6">
                        <p className="text-lg text-gray-300 leading-relaxed">
                          Digitaliza y automatiza la firma de documentos contables, facturas y contratos con nuestra solución de firma digital.
                        </p>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-gray-900/80 to-black/80 p-6 rounded-xl border border-blue-500/30 shadow-lg shadow-blue-500/10 mb-8 backdrop-blur-sm">
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                          ...
                          <div>
                            <label htmlFor="companyName" className="block text-sm font-medium text-gray-300 mb-1">Nombre de la Empresa Contable</label>
                            <div className="relative">
                              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-[#0A0A0A]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <p className="text-gray-300 text-lg text-center leading-relaxed mb-8">
              El sector contable se integra perfectamente con la plataforma de FIRMEDIGITAL, aprovechando sus funcionalidades de firma electrónica, gestión documental y flujo de trabajo. Se implementan módulos específicos para documentación contable, declaraciones fiscales y reportes financieros, creando una solución integral que se adapta a las necesidades de cada despacho contable o departamento financiero.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4">
              <span className="block text-white">Beneficios clave para</span>
              <span className="block bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">contadores</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            <div className="lg:col-span-5 order-2 lg:order-1 relative mx-auto w-full">
              <div className="w-full h-[500px] md:h-[550px] lg:h-[600px] relative">
                <img 
                  src="/images/benecontable.jpg" 
                  alt="Beneficios Contables" 
                ...
                {[
                  {
                    ...
                    description: "Control integral de documentos contables con validez legal y respaldo digital.",
                  ...
                  },
                  {
                    ...
                    description: "Gestión eficiente de facturas y pagos con firma electrónica certificada.",
                  ...
                  },
                  {
                    ...
                    description: "Generación y firma de informes con validez ante entidades fiscales.",
                  ...
                  },
                  {
                    ...
                    description: "Visualización de datos financieros con firma digital.",
                  ...
                  },
                  {
                    ...
                    description: "Gestión de documentos fiscales con certificación y trazabilidad.",
                  ...
                  },
                  {
                    ...
                    description: "Automatiza firmas y envío de reportes.",
      ...
      {/* ¿Por qué elegir FIRMEDIGITAL para contadores? Section */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Documentos contables con validez legal garantizada
            </p>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-6 text-left">
                <p className="text-xl md:text-2xl text-white leading-relaxed">
                  En FirmeDigital, garantizamos que sus informes financieros, declaraciones fiscales y documentos contables cumplen con las leyes venezolanas y se gestionan 100% dentro del territorio nacional, respaldados por SUSCERTE.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Nuestra plataforma ofrece una solución integral para contadores que asegura la validez legal de sus documentos electrónicos, cumpliendo con todos los requisitos establecidos por el SENIAT y demás entes reguladores. Al elegir FIRMEDIGITAL para su práctica contable, usted obtiene:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">Firmas digitales en estados financieros</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Validez legal en declaraciones fiscales</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Autenticación de identidad para auditorías</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Almacenamiento seguro de documentos fiscales</span>
                  </div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos contables con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la integridad y confidencialidad de la información financiera de sus clientes.
                </p>
  ...
  <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">
    {(10/12).toFixed(2)}$/mes
      ...
      {/* Aprende Más con Nuestros Recursos Section */}
      <section className="relative py-24 bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('/images/grid.svg')] bg-center opacity-5"></div>
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse"></div>
