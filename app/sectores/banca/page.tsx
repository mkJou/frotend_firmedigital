          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-8">
                ...
                ¡Firme contratos y operaciones bancarias con validez legal y cifrado bajo estándares SUSCERTE!
                </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            <div className="lg:col-span-5 order-2 lg:order-1 relative mx-auto w-full flex items-center">
              <div className="w-full h-[600px] md:h-[650px] lg:h-[700px] relative">
                <img 
                  src="/images/benebanca.jpg" 
                  alt="Beneficios Banca" 
                ...
                {[
                  {
                    ...
                    description: "Firma digital de transacciones y contratos con validez legal, agilizando procesos críticos."
                  },
                  {
                    icon: <FaUserShield className="text-4xl text-blue-400" />,
                    title: "Seguridad Financiera",
                    description: "Protección avanzada en documentos bancarios con encriptación y autenticación multifactor."
                  },
                  {
                    icon: <FaHandshake className="text-4xl text-blue-400" />,
                    title: "Servicio al Cliente",
                    description: "Gestión digital de documentación bancaria que mejora la experiencia del cliente."
                  },
                  {
                    icon: <FaChartLine className="text-4xl text-blue-400" />,
                    title: "Eficiencia Operativa",
                    description: "Reducción significativa en tiempos de procesamiento y costos administrativos."
                  },
                  {
                    icon: <FaFileContract className="text-4xl text-blue-400" />,
                    title: "Cumplimiento Normativo",
                    description: "Conformidad con regulaciones bancarias y financieras nacionales e internacionales."
                  },
                  {
                    icon: <FaUniversity className="text-4xl text-blue-400" />,
                    title: "Transformación Digital",
                    description: "Modernización de procesos bancarios tradicionales con tecnología de vanguardia."
                  }
                ].map((benefit, index) => (
                  <div
                    key={index}
        ...
        <div className="relative mx-auto max-w-7xl px-4 z-10">
          <div className="flex flex-col items-center justify-center text-center mb-10">
            <div className="inline-block mb-6 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full">
              <span className="text-white font-semibold">¿Por qué elegir FIRMEDIGITAL para el sector bancario?</span>
            </div>
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">Contratos bancarios con validez legal</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Cifrado de documentos bajo estándares SUSCERTE</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Autenticación de identidad para operaciones</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-gray-300">Cumplimiento de normativas financieras locales</span>
                  </div>
                </div>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Al digitalizar sus procesos bancarios con una plataforma certificada por SUSCERTE, garantizamos no solo el cumplimiento legal sino también la seguridad de las transacciones y la protección de datos sensibles de sus clientes, evitando riesgos asociados con el almacenamiento de información financiera en servidores extranjeros que podrían estar sujetos a legislaciones diferentes.
                </p>
